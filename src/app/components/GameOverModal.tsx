  ...
  return (
    <ModalComponent delayMs={2000} show={isOpen} onClose={onClose} showChildren={isOpen}>
      <div className="p-12 pt-9 text-center">
        ...
        <p className="mb-12 text-3xl" style={{ whiteSpace: "pre-line" }}>{getShareableEmojiScore(grid)}</p>
        <button className="py-2 px-4 bg-amber-600 text-white font-medium rounded hover:bg-[#ad8b8b] w-full mb-6" onClick={copyScore}>
          Share
        </button>
      </div>
    </ModalComponent>
